...
| AVAIL-01 | Availability combines all required schedule/policy inputs | 2 | **9 of 10 inputs passed 2026-07-30.** Gated matrix regressions cover publication (with a positive control), opening hours narrower than the shift, full-day closures, replacement hours in and out, qualification revoke/restore, lead time, advance horizon, the cleanup buffer, provider overlap, customer overlap, and chair capacity. Projection-equals-claim is asserted directly: every slot the engine offers is quoted bookable, and a claimed slot leaves the offer set. Two live end-to-end suites through the real API passed 14/14 and 16/16. **Input 4 partial:** employment is enforced; owner-as-provider cannot be booked at all, pending Q20. |
